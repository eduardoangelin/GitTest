...
from PyQt5.QtWidgets import QTableWidgetItem, QDesktopWidget, QApplication

class FrmPesquisaCliente(Diaglog):
    
    def __init__(self, db):
        print ("Entrou FrmPesquisaCliente")
        super(FrmPesquisaCliente, self).__init__()
        print ("Passou super().__init__()")
